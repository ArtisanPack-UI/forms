 ...
 * @since 1.0.0
 */
describe('Forms package migrations', function () {

    describe('forms table', function () {

        it('creates the forms table with all columns', function () {
    ...
    describe('form_steps table', function () {

        it('creates the form_steps table with all columns', function () {
        ...
        it('cascades delete when form is deleted', function () {
    ...
    describe('form_fields table', function () {

        it('creates the form_fields table with all columns', function () {
        ...
        it('enforces unique uuid constraint', function () {
            $formId = \Illuminate\Support\Facades\DB::table('forms')->insertGetId([
                'name' => 'UUID Test Form',
                'slug' => 'uuid-test',
                'created_at' => now(),
        ...
        it('sets step_id to null when step is deleted', function () {
            $formId = \Illuminate\Support\Facades\DB::table('forms')->insertGetId([
                'name' => 'Step Null Test',
                'slug' => 'step-null-test',
                'created_at' => now(),
    ...
    describe('form_submissions table', function () {

        it('creates the form_submissions table with all columns', function () {
    ...
    describe('form_uploads table', function () {

        it('creates the form_uploads table with all columns', function () {
        ...
        it('cascades delete when submission is deleted', function () {
            $formId = \Illuminate\Support\Facades\DB::table('forms')->insertGetId([
    ...
    describe('form_submission_values table', function () {

        it('creates the form_submission_values table with all columns', function () {
        ...
        it('sets field_id to null when field is deleted', function () {
            $formId = \Illuminate\Support\Facades\DB::table('forms')->insertGetId([
    ...
    describe('form_notifications table', function () {

        it('creates the form_notifications table with all columns', function () {
...
describe('Forms package configuration', function () {

    it('registers the form-uploads disk', function () {
    ...
    it('loads package configuration under artisanpack.forms', function () {
