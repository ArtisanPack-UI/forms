...
>
    ...
    <div
        ...
        aria-atomic="true"
        x-data="{ message: '' }"
        @field-added.window="message = '{{ __( 'Field added to form' ) }}'"
        @field-deleted.window="message = '{{ __( 'Field removed from form' ) }}'"
        @field-duplicated.window="message = '{{ __( 'Field duplicated' ) }}'"
        @step-added.window="message = '{{ __( 'Step added to form' ) }}'"
        @step-deleted.window="message = '{{ __( 'Step removed from form' ) }}'"
        @form-saved.window="message = '{{ __( 'Form saved successfully' ) }}'"
        x-text="message"
    ></div>
</div>
