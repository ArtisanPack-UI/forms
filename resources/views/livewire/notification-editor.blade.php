                    ...
                    @foreach ($this->notifications as $notification)
                        ...
                        >
                            <button
                                ...
                                class="flex w-full cursor-pointer items-center gap-3 rounded-lg p-3 text-left transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary {{ $selectedNotificationId === $notification->id ? 'bg-primary/10 ring-1 ring-primary hover:bg-primary/20' : 'bg-base-100 hover:bg-base-300' }}"
                            >
                                {{-- Drag handle --}}
